...
public class ReceiptWiseDailyCollection {
	 ...
	 By amalgamatedreport= By.id("ContentPlaceHolder1_ChkAmalgamated");
	 ...
	 public ReceiptWiseDailyCollection(WebDriver d)
	  ...
	  {
	 	new Select(dr.findElement(orderby)).selectByVisibleText(or);
	  }
	  ...
	  public void clickAmalgamatedReport()
	  {
