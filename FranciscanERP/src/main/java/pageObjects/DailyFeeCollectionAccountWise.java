...
WebDriver dr;
    ...
    By chqdetails= By.id("ContentPlaceHolder1_lstchqdtls");
    ...
    public void selectChequeDetails(String cd)
    {
  	  new Select(dr.findElement(chqdetails)).selectByVisibleText(cd);
    }
    public void clickCheckClearingDate()
    {
    ...
    public void clickWithHeadOneLineData()
    {
  	 dr.findElement(withheadonelinedata).click();
    }
    public void clickwithoutheadonelinedata()
    {
