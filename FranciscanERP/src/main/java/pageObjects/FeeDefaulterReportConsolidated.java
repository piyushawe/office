...
public class FeeDefaulterReportConsolidated {
	WebDriver dr;
    ...
    public void openFeeDefaulterReportConsolidated() throws InterruptedException
    {
         ...
         WebElement submenu= dr.findElement(By.linkText("Fee Defaulter"));
      	  ...
      	  //dr.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
         dr.findElement(By.linkText("Fee Defaulter Report Consolidated")).click();
         dr.switchTo().frame(dr.findElement(By.id("Fee Defaulter Report Consolidated")));
    }
    ...
    {
    	String exp= "CONSOLIDATED REPORT";
